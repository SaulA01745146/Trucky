...
def steering_angle(x_mid):
    ...
    if abs(eg) < center_threshold:
        return 0 #Si el robot esta centrado, no debe existir angulo de giro
    ...
    try:
        while not rospy.is_shutdown():
            ...
            if lines is not None:
                ...
                print(Int64(wrap_to_Pi(steering_angle(x_mid))))

                pub.publish(Int64(wrap_to_Pi(steering_angle(x_mid)))) #Publica angulo de giro
