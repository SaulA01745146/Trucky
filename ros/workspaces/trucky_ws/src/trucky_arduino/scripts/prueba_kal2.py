...
def steering_angle(pred_x, width, single_side=None):
    ...
    if abs(error) < center_threshold:
        ...
        sa = 1470 + steering_gain * abs(error)
        ...
        while not rospy.is_shutdown():
            ...
            if linesP is not None:
                ...
                if len(left_lines) > 0 or len(right_lines) > 0:
                    ...
                    sa = steering_angle(predicted_x, width, single_side)
                    #print(sa)
