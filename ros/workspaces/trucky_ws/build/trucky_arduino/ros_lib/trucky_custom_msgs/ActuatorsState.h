#ifndef _ROS_trucky_custom_msgs_ActuatorsState_h
#define _ROS_trucky_custom_msgs_ActuatorsState_h
...
namespace trucky_custom_msgs
{
  ...
  class ActuatorsState : public ros::Msg
  {
    ...
    const char * getType(){ return "trucky_custom_msgs/ActuatorsState"; };
